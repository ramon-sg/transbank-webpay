...
Transbank::Webpay.configure do |config|
  config.wsdl_transaction_url = 'http://transbank-example.cl/webpay'
  config.wsdl_nullify_url     = 'http://transbank-example.cl/nullify/webpay'
  ...
  config.commerce_code        = '1227020000123'
end
